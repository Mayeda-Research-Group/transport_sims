...
ApplyWeights<-function(data, stdpop){
  ...
  wtdest<-data.frame(WT_1=WT_1, WT_2=WT_2, WT_3=WT_3, 
                     WT_1_YA1=WT_1_YA1, WT_2_YA1=WT_2_YA1, WT_3_YA1=WT_3_YA1,
                     WT_1_YA0=WT_1_YA0, WT_2_YA0=WT_2_YA0, WT_3_YA0=WT_3_YA0)
return(wtdest)
  }
